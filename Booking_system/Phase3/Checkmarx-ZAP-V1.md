...
| Loosely Scoped Cookie | Informational | 11 |
| Session Management Response Identified | Informational | 10 |
| User Agent Fuzzer | Informational | 180 |
...
", see evidence field for the suspicious comment/snippet.`
* URL: http://localhost:8000/reservation%3Fid=3
  * Method: `GET`
  * Parameter: ``
  * Attack: ``
  * Evidence: `username`
...
localhost
csrf_token=e292cc09-33d2-41d7-9a92-fd7d453f8977
`
* URL: http://localhost:8000/login
  * Method: `GET`
  * Parameter: ``
  ...
  * Other Info: `The origin domain used for comparison was:
localhost
csrf_token=e52996e5-f5d4-4462-a40c-878af2fd78ac
`
* URL: http://localhost:8000/login
  * Method: `GET`
  * Parameter: ``
  ...
  * Other Info: `The origin domain used for comparison was:
localhost
csrf_token=f769f9b6-6e33-46a9-ae66-7f1d29b4fe83
`
...
* URL: http://localhost:8000/register
  ...
  * Other Info: `The origin domain used for comparison was:
localhost
csrf_token=5989e30b-b823-46ca-9c2d-b508520d8044
`
* URL: http://localhost:8000/register
  * Method: `GET`
  * Parameter: ``
  ...
  * Other Info: `The origin domain used for comparison was:
localhost
csrf_token=68f86481-7b7d-48c1-8134-1457388388ba
`
* URL: http://localhost:8000/register
  * Method: `GET`
  * Parameter: ``
  ...
  * Other Info: `The origin domain used for comparison was:
localhost
csrf_token=ac5040c5-35eb-4c96-b652-f902d749c994
`
* URL: http://localhost:8000/login
  * Method: `POST`
  * Parameter: ``
  ...
  * Other Info: `The origin domain used for comparison was:
localhost
session_id=04789628-eb22-4d1d-ba8d-c6b1a3212a8b
`
* URL: http://localhost:8000/login
  * Method: `POST`
  * Parameter: ``
  ...
  * Other Info: `The origin domain used for comparison was:
localhost
session_id=d8a3de4c-6365-4c74-82ad-73e87fa9658d
`
* URL: http://localhost:8000/register
  * Method: `POST`
  * Parameter: ``
  ...
  * Other Info: `The origin domain used for comparison was:
localhost
session_id=0cbd2aac-9824-447d-a529-b20f954577a6
`
* URL: http://localhost:8000/register
  * Method: `POST`
  * Parameter: ``
  ...
  * Other Info: `The origin domain used for comparison was:
localhost
session_id=a27c17ac-fc75-4a6a-af90-1959adb80701
`
...
* URL: http://localhost:8000/login
  ...
  * Attack: ``
  * Evidence: `e292cc09-33d2-41d7-9a92-fd7d453f8977`
  * Other Info: `
cookie:csrf_token`
* URL: http://localhost:8000/login
  * Method: `GET`
  * Parameter: `csrf_token`
  * Attack: ``
  * Evidence: `e52996e5-f5d4-4462-a40c-878af2fd78ac`
  * Other Info: `
cookie:csrf_token`
* URL: http://localhost:8000/login
  * Method: `GET`
  * Parameter: `csrf_token`
  * Attack: ``
  * Evidence: `f769f9b6-6e33-46a9-ae66-7f1d29b4fe83`
  * Other Info: `
cookie:csrf_token`
* URL: http://localhost:8000/register
  * Method: `GET`
  * Parameter: `csrf_token`
  * Attack: ``
  * Evidence: `5989e30b-b823-46ca-9c2d-b508520d8044`
  * Other Info: `
cookie:csrf_token`
* URL: http://localhost:8000/register
  * Method: `GET`
  * Parameter: `csrf_token`
  * Attack: ``
  * Evidence: `68f86481-7b7d-48c1-8134-1457388388ba`
  * Other Info: `
cookie:csrf_token`
* URL: http://localhost:8000/register
  * Method: `GET`
  * Parameter: `csrf_token`
  * Attack: ``
  * Evidence: `ac5040c5-35eb-4c96-b652-f902d749c994`
  * Other Info: `
cookie:csrf_token`
* URL: http://localhost:8000/login
  * Method: `POST`
  ...
  * Attack: ``
  * Evidence: `04789628-eb22-4d1d-ba8d-c6b1a3212a8b`
  * Other Info: `
cookie:session_id`
* URL: http://localhost:8000/login
  * Method: `POST`
  * Parameter: `session_id`
  * Attack: ``
  * Evidence: `d8a3de4c-6365-4c74-82ad-73e87fa9658d`
  * Other Info: `
cookie:session_id`
* URL: http://localhost:8000/register
  * Method: `POST`
  * Parameter: `session_id`
  * Attack: ``
  * Evidence: `0cbd2aac-9824-447d-a529-b20f954577a6`
  * Other Info: `
cookie:session_id`
* URL: http://localhost:8000/register
  * Method: `POST`
  * Parameter: `session_id`
  * Attack: ``
  * Evidence: `a27c17ac-fc75-4a6a-af90-1959adb80701`
  * Other Info: `
cookie:session_id`
...
* URL: http://localhost:8000/api/resources/2
  ...
  * Evidence: ``
  * Other Info: ``
* URL: http://localhost:8000/api/resources/3
  * Method: `GET`
  * Parameter: `Header User-Agent`
  * Attack: `Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1)`
  * Evidence: ``
